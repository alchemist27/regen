...
export async function GET(request: NextRequest) {
  try {
    ...
    // 필수 파라미터 확인 (OAuth 또는 Private App)
    if (!mallId) {
    ...
    const shopData = {
      ...
      user_name: userName ? decodeURIComponent(userName) : 'OAuth 사용자',
    ...
    redirectUrl.searchParams.set('user_name', userName ? decodeURIComponent(userName) : 'OAuth 사용자');
